...
import com.ismartcoding.plain.lib.apk.bean.AdaptiveIcon
import com.ismartcoding.plain.lib.apk.bean.ApkMeta
import com.ismartcoding.plain.lib.apk.bean.ApkSignStatus
import com.ismartcoding.plain.lib.apk.bean.ApkSigner
import com.ismartcoding.plain.lib.apk.bean.ApkV2Signer
import com.ismartcoding.plain.lib.apk.bean.CertificateMeta
import com.ismartcoding.plain.lib.apk.bean.DexClass
import com.ismartcoding.plain.lib.apk.bean.Icon
import com.ismartcoding.plain.lib.apk.bean.IconFace
import com.ismartcoding.plain.lib.apk.bean.IconPath
import com.ismartcoding.plain.lib.apk.exception.ParserException
import com.ismartcoding.plain.lib.apk.parser.AdaptiveIconParser
import com.ismartcoding.plain.lib.apk.parser.ApkMetaTranslator
import com.ismartcoding.plain.lib.apk.parser.ApkSignBlockParser
import com.ismartcoding.plain.lib.apk.parser.BinaryXmlParser
import com.ismartcoding.plain.lib.apk.parser.CertificateMetas
import com.ismartcoding.plain.lib.apk.parser.CertificateParser
import com.ismartcoding.plain.lib.apk.parser.CompositeXmlStreamer
import com.ismartcoding.plain.lib.apk.parser.DexParser
import com.ismartcoding.plain.lib.apk.parser.ResourceTableParser
import com.ismartcoding.plain.lib.apk.parser.XmlStreamer
import com.ismartcoding.plain.lib.apk.parser.XmlTranslator
import com.ismartcoding.plain.lib.apk.struct.AndroidConstants
import com.ismartcoding.plain.lib.apk.struct.resource.Densities
import com.ismartcoding.plain.lib.apk.struct.resource.ResourceTable
import com.ismartcoding.plain.lib.apk.struct.signingv2.ApkSigningBlock
import com.ismartcoding.plain.lib.apk.struct.zip.EOCD
...
abstract class AbstractApkFile : Closeable {
    ...
    private fun parseCertificates() {
        ...
        for (file in allCertificateData) {
            val parser: CertificateParser = CertificateParser.Companion.getInstance(
                file.data!!
            )
