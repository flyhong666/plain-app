package com.ismartcoding.plain.lib.pdfviewer.scroll
        ...
        override fun setupLayout(pdfView: PDFView) {
            ...
            if (pdfView.isSwipeVertical) {
                ...
                if (inverted) { // left
                    ...
                    background = drawableByName("default_scroll_handle_left")
                } else { // right
                    align = ALIGN_PARENT_RIGHT
                    background = drawableByName("default_scroll_handle_right")
                }
            } else {
                width = HANDLE_SHORT
                height = HANDLE_LONG
                if (inverted) { // top
                    ...
                    background = drawableByName("default_scroll_handle_top")
                } else { // bottom
                    align = ALIGN_PARENT_BOTTOM
                    background = drawableByName("default_scroll_handle_bottom")
                }
            }
