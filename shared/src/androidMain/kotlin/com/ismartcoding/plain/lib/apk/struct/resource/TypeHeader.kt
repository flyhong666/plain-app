...
import com.ismartcoding.plain.lib.apk.utils.Buffers.readUByte
...
import com.ismartcoding.plain.lib.apk.utils.Buffers.skip
...
class TypeHeader(headerSize: Int, chunkSize: Long, buffer: ByteBuffer) :
    ...
    init {
        ...
        entriesStart = Unsigned.ensureUInt(Buffers.readUInt(buffer));
