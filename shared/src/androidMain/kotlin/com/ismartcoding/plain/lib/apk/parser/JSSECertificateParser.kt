...
import com.ismartcoding.plain.lib.apk.cert.asn1.Asn1BerParser
import com.ismartcoding.plain.lib.apk.cert.asn1.Asn1DecodingException
import com.ismartcoding.plain.lib.apk.cert.pkcs7.ContentInfo
import com.ismartcoding.plain.lib.apk.cert.pkcs7.Pkcs7Constants
import com.ismartcoding.plain.lib.apk.cert.pkcs7.SignedData
import com.ismartcoding.plain.lib.apk.utils.Buffers.readBytes
...
internal class JSSECertificateParser(data: ByteArray) : CertificateParser(data) {
    ...
    override fun parse(): List<CertificateMeta> {
        ...
        for (i in encodedCertificates.indices) {
            ...
            val encodedForm: ByteArray = Buffers.readBytes(encodedCertificate.encoded)
