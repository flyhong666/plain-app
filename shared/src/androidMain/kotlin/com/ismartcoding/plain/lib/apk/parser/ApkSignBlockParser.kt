...
import com.ismartcoding.plain.lib.apk.struct.signingv2.Digest
import com.ismartcoding.plain.lib.apk.struct.signingv2.Signature
import com.ismartcoding.plain.lib.apk.struct.signingv2.SignerBlock
...
class ApkSignBlockParser(data: ByteBuffer) {
    ...
    fun parse(): ApkSigningBlock {
        ...
        while (data.remaining() >= 8) {
            ...
            if (id == ApkSigningBlock.Companion.SIGNING_V2_ID) {
    ...
    private fun readDigests(buffer: ByteBuffer): List<Digest> {
        ...
        while (buffer.hasRemaining()) {
            ...
            val digest: ByteArray = Buffers.readBytes(digestData)
