...
import com.ismartcoding.plain.lib.apk.struct.dex.DexClassStruct
import com.ismartcoding.plain.lib.apk.struct.dex.DexHeader
...
class DexParser(buffer: ByteBuffer) {
    ...
    private fun readDexHeader(): DexHeader {
        ...
        // signature skip
        Buffers.readBytes(buffer, DexHeader.Companion.kSHA1DigestLen)
