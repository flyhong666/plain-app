package com.ismartcoding.plain.lib.apk.struct

import com.ismartcoding.plain.lib.apk.struct.resource.Densities
import com.ismartcoding.plain.lib.apk.struct.resource.ResourceEntry
    ...
    class ReferenceResourceValue(value: Int) : ResourceValue(value) {
        override fun toStringValue(resourceTable: ResourceTable?, locale: Locale?): String? {
            ...
            if (resourceId > AndroidConstants.SYS_STYLE_ID_START && resourceId < AndroidConstants.SYS_STYLE_ID_END) {
                return "@android:style/" + ResourceTable.Companion.sysStyle[resourceId.toInt()]
            }
