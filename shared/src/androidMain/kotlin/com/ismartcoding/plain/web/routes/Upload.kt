                        ...
                        when (part.name) {
                            ...
                            "file" -> {
                                ...
                                if (info.isAppFile) {
                                    ...
                                    val tempFile = File(appContext.cacheDir, "chat_upload_${System.currentTimeMillis()}_${Thread.currentThread().id}")
                                    ...
                                    appContext.scanFileByConnection(destFile, null)
                                }
                            }
                    ...
                    is PartData.FileItem -> {
                        when (part.name) {
                            ...
                            "file" -> {
                                ...
                                val chunkDir = File(appContext.filesDir, "upload_tmp/${chunkInfo.fileId}")
                                chunkDir.mkdirs()
