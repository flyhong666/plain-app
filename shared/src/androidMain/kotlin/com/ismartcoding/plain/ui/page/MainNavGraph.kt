...
fun MainNavGraph(
    ...
    NavHost(
        ...
        composable<Routing.PomodoroTimer> {
            ...
            PomodoroPage(
                ...
                onCheckNotificationPermission = { onGranted ->
                    Permissions.checkNotification(context, Res.string.pomodoro_notification_prompt) { onGranted() }
                },
            )
        }
        ...
        composable<Routing.WebDev> {
            val context = LocalContext.current
            WebDevPage(navController, packageId = context.packageName, onResetToken = {
        ...
        composable<Routing.HowToUse> {
            ...
            HowToUsePage(navController, onRunDiagnostics = { webVM.dig(context) })
        }
        ...
        composable<Routing.ChatText> { backStackEntry ->
            ...
            ChatTextPage(navController, r.content, onPrint = { tm, jobName, content ->
                PrintHelper.printText(context, tm, jobName, content)
            })
        }
        composable<Routing.ChatEditText> { backStackEntry ->
            ...
            ChatEditTextPage(navController, r.content, onSave = { text ->
                coIO {
                    ...
                    ChatMessageEditor.updateTextAsync(context, originalChat, text)
